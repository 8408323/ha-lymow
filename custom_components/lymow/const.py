...
# ---------------------------------------------------------------------------
# Error-code -> description. Codes + symbolic names are AUTHORITATIVE: extracted
# from the app's PbErrorCode enum in the Hermes-v96 bytecode (hbc-disassembler,
# 2026-05-30) by pairing each enum member with its LoadConst value. Descriptions
# are humanized from the symbolic names; codes 18/71 use the app's wording.
ERROR_DESCRIPTIONS: dict[int, str] = {
    ...
    13: "Localization visual-inertial failed",
    14: "Localization EKF failed",
    15: "Localization init RTK not fix",
    16: "Localization init timeout",
    17: "Robot cliff",
    ...
    61: "Localization RTK base",
    62: "Map not match",
    63: "Charge station invalid",
    64: "Robot in no-go",
    65: "Robot in no-go wall",
    66: "Robot stuck trapped",
    67: "Path-planning solver fail",
    68: "Path-planning search fail",
    69: "BD fail",
    70: "Channel offset",
    71: "Navigation action timeout",
    ...
    79: "Localization yaw abnormal",
    80: "Dock timeout",
    81: "Localization edge score low",
    82: "Localization BD score low",
    83: "Channel slip",
    84: "Slope slip",
...
# Warning-code -> description. Codes + symbolic names are AUTHORITATIVE: extracted
# from the app's PbWarningCode enum in the Hermes-v96 bytecode (hbc-disassembler,
# 2026-05-30); values read from each member's LoadConst register (declaration order
# is non-sequential, so positions were not assumed). Descriptions humanized.
WARNING_DESCRIPTIONS: dict[int, str] = {
    ...
    40: "No-go not in zone",
    41: "Channel start not in zone",
    42: "Only one docking channel allowed",
    43: "Zone eight path",
    44: "Modify zone far from edge",
    45: "Modify zone start close end",
    46: "Modify zone change channel point",
    47: "Modify zone internal fail",
    48: "Can not find objects",
